 ...
 * @package    Codilar\Gst\Block\Adminhtml\Order\View\Items\Renderer
 * @copyright   Copyright (c) 2017 Codilar. (http://www.codilar.com)
 * @purpose     Overriding Core file for sales order view items renderer
 * @author       Codilar Team
 **/
namespace Codilar\Gst\Block\Adminhtml\Order\View\Items\Renderer;
...
class DefaultRenderer extends \Magento\Sales\Block\Adminhtml\Items\Renderer\DefaultRenderer
{
    ...
    {
        $this->setTemplate("Codilar_Gst::order/view/items/renderer/default.phtml");
